...
*** Check services:
    ...
    | pod/funkwhale-postgres-0            | 0/1       | CreateContainerConfigError | 0           | 3m38s    |       |
    | NAME                                | TYPE      | CLUSTER-IP                 | EXTERNAL-IP | PORT(S)  | AGE   |
    | service/funkwhale-postgres          | ClusterIP | 10.43.107.165              | <none>      | 5432/TCP | 3m39s |
    | NAME                                | READY     | AGE                        |             |          |       |
    | statefulset.apps/funkwhale-postgres | 0/1       | 3m39s                      |             |          |       |
