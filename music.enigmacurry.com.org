...
*** Check services:
    Check the status of each of the helm releases:
    #+begin_src shell :noweb yes :eval never-export :exports code :results output
    ...
    : funkwhale   True    Release reconciliation succeeded   8m47s
    ...
    | pod/funkwhale-funkwhale-redis-master-0                | 1/1       | Running      |           0 | 2m42s    |       |
    | pod/funkwhale-funkwhale-worker-8674d65f7b-9cg25       | 1/1       | Running      |           0 | 2m42s    |       |
    | pod/funkwhale-funkwhale-worker-8674d65f7b-cnv6r       | 1/1       | Running      |           0 | 2m42s    |       |
    | pod/funkwhale-funkwhale-beat-696b558c8d-f4t4n         | 1/1       | Running      |           0 | 2m42s    |       |
    | pod/funkwhale-funkwhale-844fb49494-wt92d              | 2/2       | Running      |           0 | 2m42s    |       |
    | NAME                                                  | TYPE      | CLUSTER-IP   | EXTERNAL-IP | PORT(S)  | AGE   |
    | service/funkwhale-funkwhale-redis-headless            | ClusterIP | None         |      <none> | 6379/TCP | 2m43s |
    | service/funkwhale-funkwhale-redis-master              | ClusterIP | 10.43.63.150 |      <none> | 6379/TCP | 2m43s |
    | service/funkwhale-funkwhale                           | ClusterIP | 10.43.80.112 |      <none> | 80/TCP   | 2m43s |
    | NAME                                                  | READY     | UP-TO-DATE   |   AVAILABLE | AGE      |       |
    | deployment.apps/funkwhale-funkwhale-worker            | 2/2       | 2            |           2 | 2m42s    |       |
    | deployment.apps/funkwhale-funkwhale-beat              | 1/1       | 1            |           1 | 2m42s    |       |
    | deployment.apps/funkwhale-funkwhale                   | 1/1       | 1            |           1 | 2m42s    |       |
    | NAME                                                  | DESIRED   | CURRENT      |       READY | AGE      |       |
    | replicaset.apps/funkwhale-funkwhale-worker-8674d65f7b | 2         | 2            |           2 | 2m43s    |       |
    | replicaset.apps/funkwhale-funkwhale-beat-696b558c8d   | 1         | 1            |           1 | 2m43s    |       |
    | replicaset.apps/funkwhale-funkwhale-844fb49494        | 1         | 1            |           1 | 2m43s    |       |
    | NAME                                                  | READY     | AGE          |             |          |       |
    | statefulset.apps/funkwhale-funkwhale-redis-master     | 1/1       | 2m43s        |             |          |       |
