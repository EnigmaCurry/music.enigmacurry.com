...
*** Add Bitnami Helm chart repository to Flux:
    ...
    #+end_src
*** Configure postgresql Helm values
    ...
    persistence.size: <<FUNKWHALE_POSTGRESQL_PVC_SIZE>>
    #+end_src
*** Create postgresql Helm release
    #+begin_src shell :noweb yes :eval never-export :exports code :results none
...
*** Check services:
    ...
    | pod/funkwhale-postgresql-postgresql-0            | 1/1       | Running      | 0           | 67s      |     |
    | NAME                                             | TYPE      | CLUSTER-IP   | EXTERNAL-IP | PORT(S)  | AGE |
    | service/funkwhale-postgresql-headless            | ClusterIP | None         | <none>      | 5432/TCP | 68s |
    | service/funkwhale-postgresql                     | ClusterIP | 10.43.130.16 | <none>      | 5432/TCP | 68s |
    | NAME                                             | READY     | AGE          |             |          |     |
    | statefulset.apps/funkwhale-postgresql-postgresql | 1/1       | 68s          |             |          |     |
    ...
    | data-funkwhale-postgresql-postgresql-0 | Bound  | pvc-ce5d22f1-2138-4d92-9af4-d8a082ffe4fe | 8Gi      | RWO    | local-path | 74s          |     |
