...
*** Check services:
    ...
    funkwhale   Unknown   Reconciliation in progress   4s
    NAME                                              READY   STATUS              RESTARTS   AGE
    pod/funkwhale-funkwhale-worker-5797c7c658-bhj9l   0/1     Pending             0          2s
    pod/funkwhale-funkwhale-5dfd4c9d64-fp6qw          0/2     Pending             0          2s
    pod/funkwhale-funkwhale-worker-5797c7c658-fgkdr   0/1     Pending             0          2s
    pod/funkwhale-funkwhale-beat-696b558c8d-n46gb     0/1     ContainerCreating   0          2s
    pod/funkwhale-funkwhale-redis-master-0            0/1     ContainerCreating   0          2s

    NAME                                         TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)    AGE
    service/funkwhale-funkwhale-redis-headless   ClusterIP   None            <none>        6379/TCP   3s
    service/funkwhale-funkwhale-redis-master     ClusterIP   10.43.159.23    <none>        6379/TCP   3s
    service/funkwhale-funkwhale                  ClusterIP   10.43.253.185   <none>        80/TCP     3s

    NAME                                         READY   UP-TO-DATE   AVAILABLE   AGE
    deployment.apps/funkwhale-funkwhale-beat     0/1     1            0           3s
    deployment.apps/funkwhale-funkwhale          0/1     1            0           3s
    deployment.apps/funkwhale-funkwhale-worker   0/2     2            0           3s

    NAME                                                    DESIRED   CURRENT   READY   AGE
    replicaset.apps/funkwhale-funkwhale-5dfd4c9d64          1         1         0       3s
    replicaset.apps/funkwhale-funkwhale-beat-696b558c8d     1         1         0       3s
    replicaset.apps/funkwhale-funkwhale-worker-5797c7c658   2         2         0       3s

    NAME                                                READY   AGE
    statefulset.apps/funkwhale-funkwhale-redis-master   0/1     3s
    #+end_example
    ...
    | funkwhale-funkwhale | Pending | local-path | 16s      |        |       |              |     |
