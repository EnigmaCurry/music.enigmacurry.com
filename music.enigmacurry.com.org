...
#+END_COMMENT
#+INCLUDE: "~/git/vendor/enigmacurry/literate-k3s/lib/rook.org"
* Funkwhale
** Funkwhale Config
*** FUNKWHALE_DOMAIN
...
*** Check services:
    ...
    funkwhale   Unknown   Reconciliation in progress   4m50s
    NAME                                              READY   STATUS    RESTARTS   AGE
    pod/funkwhale-funkwhale-worker-5797c7c658-2z5k2   0/1     Pending   0          4m48s
    pod/funkwhale-funkwhale-5dfd4c9d64-kdpdl          0/2     Pending   0          4m48s
    pod/funkwhale-funkwhale-worker-5797c7c658-4xmbg   0/1     Pending   0          4m48s
    pod/funkwhale-funkwhale-beat-696b558c8d-kcjqz     1/1     Running   0          4m48s
    pod/funkwhale-funkwhale-redis-master-0            1/1     Running   0          4m48s

    NAME                                         TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)    AGE
    service/funkwhale-funkwhale-redis-headless   ClusterIP   None            <none>        6379/TCP   4m49s
    service/funkwhale-funkwhale-redis-master     ClusterIP   10.43.208.71    <none>        6379/TCP   4m49s
    service/funkwhale-funkwhale                  ClusterIP   10.43.208.197   <none>        80/TCP     4m49s

    NAME                                         READY   UP-TO-DATE   AVAILABLE   AGE
    deployment.apps/funkwhale-funkwhale          0/1     1            0           4m49s
    deployment.apps/funkwhale-funkwhale-worker   0/2     2            0           4m49s
    deployment.apps/funkwhale-funkwhale-beat     1/1     1            1           4m49s

    NAME                                                    DESIRED   CURRENT   READY   AGE
    replicaset.apps/funkwhale-funkwhale-5dfd4c9d64          1         1         0       4m49s
    replicaset.apps/funkwhale-funkwhale-worker-5797c7c658   2         2         0       4m49s
    replicaset.apps/funkwhale-funkwhale-beat-696b558c8d     1         1         1       4m49s

    NAME                                                READY   AGE
    statefulset.apps/funkwhale-funkwhale-redis-master   1/1     4m49s
    #+end_example
    ...
    | funkwhale-funkwhale | Pending | local-path | 25m      |        |       |              |     |
