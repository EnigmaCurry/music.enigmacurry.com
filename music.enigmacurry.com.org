...
*** Check services:
    ...
    funkwhale   True    Release reconciliation succeeded   66m
    NAME                                              READY   STATUS    RESTARTS   AGE
    pod/funkwhale-funkwhale-beat-696b558c8d-gjwwm     1/1     Running   0          66m
    pod/funkwhale-funkwhale-worker-5797c7c658-hkpgr   1/1     Running   0          66m
    pod/funkwhale-funkwhale-worker-5797c7c658-t6227   1/1     Running   0          66m
    pod/funkwhale-funkwhale-redis-master-0            1/1     Running   0          66m
    pod/funkwhale-funkwhale-5dfd4c9d64-xv7gh          2/2     Running   22         66m

    NAME                                         TYPE        CLUSTER-IP      EXTERNAL-IP   PORT(S)    AGE
    service/funkwhale-funkwhale-redis-headless   ClusterIP   None            <none>        6379/TCP   66m
    service/funkwhale-funkwhale                  ClusterIP   10.43.18.107    <none>        80/TCP     66m
    service/funkwhale-funkwhale-redis-master     ClusterIP   10.43.221.194   <none>        6379/TCP   66m

    NAME                                         READY   UP-TO-DATE   AVAILABLE   AGE
    deployment.apps/funkwhale-funkwhale-beat     1/1     1            1           66m
    deployment.apps/funkwhale-funkwhale-worker   2/2     2            2           66m
    deployment.apps/funkwhale-funkwhale          1/1     1            1           66m

    NAME                                                    DESIRED   CURRENT   READY   AGE
    replicaset.apps/funkwhale-funkwhale-beat-696b558c8d     1         1         1       66m
    replicaset.apps/funkwhale-funkwhale-worker-5797c7c658   2         2         2       66m
    replicaset.apps/funkwhale-funkwhale-5dfd4c9d64          1         1         1       66m

    NAME                                                READY   AGE
    statefulset.apps/funkwhale-funkwhale-redis-master   1/1     66m
    #+end_example
