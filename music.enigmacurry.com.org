...
*** Check services:
    ...
    | pod/funkwhale-postgres-0            | 1/1       | Running       | 0           | 8m58s    |       |
    | NAME                                | TYPE      | CLUSTER-IP    | EXTERNAL-IP | PORT(S)  | AGE   |
    | service/funkwhale-postgres          | ClusterIP | 10.43.107.165 | <none>      | 5432/TCP | 8m59s |
    | NAME                                | READY     | AGE           |             |          |       |
    | statefulset.apps/funkwhale-postgres | 1/1       | 8m59s         |             |          |       |
